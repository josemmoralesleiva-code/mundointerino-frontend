...
export default function VerificacionDocente() {
  ...
  const [paso, setPaso] = useState(1) // 1: administración, 2: documento, 3: confirmación
  ...
  const handleEnviar = async () => {
    ...
    try {
      ...
      await axios.post(`${API}/api/usuarios/verificacion-docente`, formData, {
        headers: {
      ...
      setError(err.response?.data?.error || 'Error al enviar la documentación. Inténtalo de nuevo.')
    } finally {
      setEnviando(false)
    }
  }
          ...
          <div className="bg-white rounded-3xl border border-gray-100 shadow-sm p-8 hover:shadow-xl transition-all duration-300">
            ...
            <div className="flex gap-3">
              ...
              <button
                ...
                disabled={!archivo || !tipoDoc || enviando}
