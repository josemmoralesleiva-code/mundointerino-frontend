  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <nav className="bg-white shadow-sm px-6 py-4">
        <div className="max-w-6xl mx-auto flex justify-between items-center">
          ...
          <ul className="hidden md:flex items-center gap-6 list-none">
            <li>
              <button onClick={() => navigate('/pisos')} className="text-gray-700 hover:text-blue-700 font-medium">
                Buscar piso
              </button>
            </li>
            <li>
      ...
      <section className="bg-blue-700 text-white py-20 px-6 text-center relative">
        <div className="max-w-4xl mx-auto">
          <h1 className="text-4xl md:text-5xl font-bold mb-4 leading-tight">
            ...
            <span className="text-yellow-300">para docentes interinos</span><br />
            en Aragón
          </h1>
          ...
          <div className="bg-white rounded-2xl p-4 max-w-4xl mx-auto flex flex-col md:flex-row gap-3">
            <div className="flex-1 flex flex-col items-start px-2">
              ...
              <input
                ...
                className="w-full text-gray-700 focus:outline-none focus:border-blue-400 border border-gray-200 rounded-xl px-3 py-2"
              />
            </div>
            <div className="flex flex-col items-start px-2">
              ...
              <input
                ...
                className="text-gray-700 focus:outline-none focus:border-blue-400 border border-gray-200 rounded-xl px-3 py-2"
              />
            </div>
            <div className="flex flex-col items-start px-2">
      ...
      <section className="max-w-5xl mx-auto px-6 pb-16">
        ...
        {/* Aquí se renderizarán las cards desde el componente PisoCard o datos de la API */}
        ...
        <div className="text-center mt-8">
          <button
            ...
            className="bg-blue-700 text-white px-8 py-3 rounded-xl font-semibold hover:bg-blue-800 text-lg"
          >
            Ver todos los pisos
          </button>
        </div>
      ...
      <section className="bg-blue-700 py-14 px-6 text-center text-white">
        <div className="max-w-3xl mx-auto">
          ...
          <button
            onClick={() => navigate('/publicar')}
            className="bg-white text-blue-700 font-bold px-8 py-3 rounded-xl hover:bg-blue-50 text-lg"
          >
