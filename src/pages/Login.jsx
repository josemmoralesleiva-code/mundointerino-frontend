            ...
            >
              ...
              <div className="relative h-full flex flex-col justify-end p-10 text-white">
                <h1 className="text-4xl font-bold leading-tight mb-4">
                  Accede a tu espacio
                  <span className="text-accent-400 block">como docente</span>
                </h1>
                <p className="text-primary-100 text-lg max-w-md">
                  Gestiona tus favoritos, tus conversaciones y tus búsquedas en un solo lugar.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-3xl shadow-xl border border-gray-100 p-8 md:p-10">
            <div className="mb-8 text-center">
              ...
              <p className="text-gray-500 mt-2">
                Entra en tu cuenta para guardar favoritos y contactar con propietarios.
              </p>
            </div>
            ...
            <div className="mt-8 grid grid-cols-3 gap-3 text-center text-xs text-gray-500">
              <div className="bg-gray-50 rounded-xl py-3">Favoritos</div>
              <div className="bg-gray-50 rounded-xl py-3">Chat</div>
