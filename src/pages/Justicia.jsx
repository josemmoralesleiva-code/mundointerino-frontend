...
const PANELES = [
  {
    ...
    icono: '💬',
    descripcion: 'Dudas sobre juzgados, destinos, concursos, traslados y alojamiento.',
  ...
  },
  {
    titulo: 'Permutas',
    icono: '🔁',
    descripcion: 'Intercambia destino, alojamiento o información con otros interinos.',
  ...
  },
  {
    ...
    icono: '🚗',
    descripcion: 'Comparte desplazamientos al juzgado o tribunal.',
  ...
  },
  {
    titulo: 'Recursos',
    icono: '📚',
    descripcion: 'Guías, documentos y recursos útiles para personal de justicia.',
...
const DESTACADOS = [
  { icon: '⚖️', texto: 'Juzgados y tribunales por provincia.' },
  { icon: '🏠', texto: 'Vivienda temporal cerca de tu destino judicial.' },
  { icon: '🤝', texto: 'Comunidad de apoyo entre profesionales de justicia.' },
  { icon: '📋', texto: 'Espacio pensado para interinos y desplazados del sector.' },
]
    ...
    <div className="min-h-screen bg-[#F8F5EF]">
      ...
      >
        ...
        <div className="relative max-w-5xl mx-auto">
          ...
          <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-6">
            <div>
              <span className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/10 text-white text-xs mb-4 border border-white/20 backdrop-blur-md">
                ⚖️ Administración · Justicia
              </span>
              <h1 className="text-3xl md:text-4xl font-bold leading-tight drop-shadow-lg">
                Espacio <span className="text-[#D4AF37]">Justicia</span>
              </h1>
              <p className="mt-3 text-slate-100 text-sm md:text-base max-w-2xl leading-relaxed">
                Un espacio exclusivo para interinos de justicia. Alojamiento cerca de tu juzgado, apoyo entre compañeros y recursos para tu día a día.
              </p>
            </div>
            <button
          ...
          <div className="flex justify-start gap-6 mt-5 text-xs md:text-sm text-slate-100 flex-wrap">
            <span>✅ Solo para personal de justicia verificado</span>
      ...
      <section className="max-w-6xl mx-auto px-6 py-14">
        <div className="text-center mb-10">
          <h2 className="text-2xl font-bold text-gray-900 mb-2">Tu espacio de justicia</h2>
          <p className="text-gray-500 text-sm">Accede a cada sección pensada para tu día a día como interino de justicia.</p>
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="bg-gradient-to-br from-[#0F172A] to-[#1E3A5F] rounded-3xl p-8 text-white">
              ...
              <ul className="space-y-3 text-sm text-white/80">
                {[
                  'Busca alojamiento cerca del juzgado.',
