...
export default function Province() {
  ...
  const ciudades = DATA[comunidad as string]?.[provincia as string] || []
      ...
      <section className="bg-white border-b border-gray-100 py-10 px-6">
        <div className="max-w-6xl mx-auto">
          <button onClick={() => navigate(`/zonas/${comunidad}`)} className="text-sm text-gray-500 hover:text-gray-700">
            ← Volver a {NOMBRES[comunidad as string] || 'la comunidad'}
          </button>
          <h1 className="text-3xl font-bold text-gray-800 mt-2">{PROVINCIA_NAMES[provincia as string] || provincia}</h1>
