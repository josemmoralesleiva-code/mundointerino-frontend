...
export default function PropertyDetail() {
  ...
  const { property: piso, loading, error, fetchById } = useProperties()
  ...
  const propietario = piso.propietario as OwnerSummary
                ...
                <div className="bg-white rounded-3xl p-6 border border-gray-100 shadow-sm">
                  ...
                  <div className="flex items-center gap-4 bg-gradient-to-r from-gray-50 to-primary-50 rounded-2xl p-5 border border-gray-100">
                    ...
                    <div className="flex-1 min-w-0">
                      <p className="font-bold text-gray-900">{propietario.nombre || 'Propietario'}</p>
                      {propietario.email && (
                        <p className="text-gray-500 text-sm mt-0.5 truncate">✉️ {propietario.email}</p>
                      )}
                      {propietario.telefono && (
                        <p className="text-gray-500 text-sm">📞 {propietario.telefono}</p>
                      )}
                    </div>
              ...
              <div className="sticky top-[152px] space-y-4">
                <div className="bg-white rounded-3xl p-6 border border-gray-100 shadow-sm">
                  ...
                  <div className="space-y-3">
                    ...
                    {propietario?.email && (
                      <a
                        href={`mailto:${propietario.email}?subject=Consulta sobre ${encodeURIComponent(piso.titulo)}`}
                    ...
                    {propietario?.telefono && (
                      <a
                        href={`https://wa.me/${propietario.telefono.replace(/\s/g, '')}?text=Hola, me interesa el piso: ${encodeURIComponent(piso.titulo)}`}
                        target="_blank"
                        rel="noopener noreferrer"
